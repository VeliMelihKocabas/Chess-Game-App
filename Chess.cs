...
namespace CHESS
{
    class Program
    {
        ...
        static string[,] coordinates = new string[,] {{ "a8", "b8", "c8", "d8", "e8", "f8", "g8","h8"},//coordinate table for mode 2
        ...
        {
            File.OpenWrite("savedgame.txt").Close();
            StreamWriter saved = File.AppendText("savedgame.txt");
            if (turn % 2 == 0)
            {
        ...
        static void Hint(int start_x, int start_y, int num)
        {
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    ...
                    {
                        if (RookWhite(start_x, start_y, i, j) == true && table[i, j].StartsWith('b'))
                        {
                            Console.SetCursorPosition(0, 28);
                            Console.WriteLine("Pressed H!");
                    ...
                    {
                        if (RookBlack(start_x, start_y, i, j) == true && table[i, j].StartsWith('w'))
                        {
                            Console.SetCursorPosition(0, 28);
                            Console.WriteLine("Pressed H!");
                            Console.Write("Hint: " + "Rx" + columns[j] + rows[i]);
                    ...
                    {
                        if (QueenBlack(start_x, start_y, i, j) == true && table[i, j].StartsWith('w'))
                        {
                            Console.SetCursorPosition(0, 28);
                            Console.WriteLine("Pressed H!");
                            Console.Write("Hint: " + "Qx" + columns[j] + rows[i]);
        ...
        static void Main(string[] args)
        {
            ...
            DeleteSavedGame("savedgame.txt", choise);
                        ...
                        if (Console.KeyAvailable)
                        {
                            ...
                            if (cki.Key == ConsoleKey.Spacebar)
                            {
                                if (colour % 4 == 2 || colour % 4 == 3)
                                {
                                    ...
                                    if ((counter == 1) & (table[row, col] != ".") & (table[row,col].StartsWith('b')))   //is the place where the desired stone to be played is determined for black.
                                    {
                                        Console.SetCursorPosition(10, 0);
                                    ...
                                    else if ((counter == -1) & (table[row, col].StartsWith('w') || table[row, col] == "."))//where the selected stone is placed for black pieces.
                                    {
                                        ...
                                        else if (stone == "K")
                                        {
                                            ...
                                            else if (KingBlack(start_x, start_y, row, col) == true)
                                            {
                                                Console.SetCursorPosition(10, 0);
                                                Console.ResetColor();
                                                Console.WriteLine("White's turn");
                                ...
                                if (colour % 4 == 0 || colour % 4 == 1)
                                {
                                    ...
                                    if ((counter == 1) & (table[row, col] != ".") & (table[row, col].StartsWith('w')))    //is the place where the desired stone to be played is determined for white.
                                    {
                                        Console.ResetColor();
                                        Console.SetCursorPosition(10, 0);
                                        Console.WriteLine("White's turn");
                                    ...
                                    else if ((counter == -1) & (table[row, col].StartsWith('b') || table[row, col] == "."))  //where the selected stone is placed for white pieces.
                                    {
                                        if (stone == "P")
                                        {
                                            if (row == 0)//promotion
                    ...
                    while (true)
                    {
                                        ...
                                        if (colour % 4 == 0 || colour % 4 == 1)
                                        {
                                            ...
                                            else if (notation[0] == 'N')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wn" && KnightWhite(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))                                   //Control notation for knight movement
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'R')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wr" && Rook(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))                                          //Control notation for rook movement
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                            break;
                                            ...
                                            else if (notation[0] == 'B')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wb" && BishopWhite(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))                                  //Control notation for bishop movement
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'Q')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wq" && (Rook(k, t, row, col) == true || BishopWhite(k, t, row, col) == true) && table[row, col] == "." && !notation.Contains('x'))            //Control notation for queen movement
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'K')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wk" && KingWhite(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))                                   //Control notation for king movement
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                        ...
                                        else if (colour % 4 == 2 || colour % 4 == 3)
                                        {
                                            ...
                                            else if (notation[0] == 'N')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "bn" && KnightBlack(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'R')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "br" && Rook(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                            break;
                                            ...
                                            else if (notation[0] == 'B')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "bb" && BishopBlack(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'Q')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "bq" && (Rook(k, t, row, col) == true || BishopWhite(k, t, row, col) == true) && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'K')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "bk" && KingBlack(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                        ...
                        while (true)
                        {
                            if (colour % 4 == 2 || colour % 4 == 3)
                            {
                                ...
                                if (counter == 1 & table[start_x, start_y] != "." & (table[start_x, start_y].StartsWith('b')))
                                {
                                    Console.SetCursorPosition(10, 0);
                                    Console.WriteLine("Black's turn");
                                    Console.SetCursorPosition(cursorx, cursory);
                                ...
                                else if (counter == -1 & (table[row, col].StartsWith('w') || table[row, col] == ".")) 
                                {
                                    Console.ForegroundColor = ConsoleColor.Red;
                                    if (stone == "P")
                                    {
                            ...
                            {
                                Console.ResetColor();
                                if (counter == 1 & table[start_x, start_y] != "." & table[start_x, start_y].StartsWith('w'))
                                {
                                    Console.SetCursorPosition(10, 0);
                                    Console.WriteLine("White's turn");
                                    Console.SetCursorPosition(cursorx, cursory);
                                ...
                                else if (counter == -1 & (table[row, col].StartsWith('b') || table[row, col] == "."))
                                {
                                    Console.ForegroundColor = ConsoleColor.Blue;
                                    if (stone == "P")
                                    {
                                        ...
                                        if (colour % 4 == 0 || colour % 4 == 1)
                                        {
                                            ...
                                            else if (notation[0] == 'N')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wn" && KnightWhite(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'R')
                                            {
                                                ...
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (num == 0 && table[k, t] == "wr" && Rook(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                            num++;
                                            ...
                                            else if (notation[0] == 'B')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wb" && BishopWhite(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'Q')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wq" && (Rook(k, t, row, col) == true || BishopWhite(k, t, row, col) == true) && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                            ...
                                            else if (notation[0] == 'K')
                                            {
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (table[k, t] == "wk" && KingWhite(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                        }
                                        ...
                                        else if (colour % 4 == 2 || colour % 4 == 3)
                                        {
                                            ...
                                            else if (notation[0] == 'R')
                                            {
                                                ...
                                                for (int k = 0; k < 8; k++)
                                                {
                                                    for (int t = 0; t < 8; t++)
                                                    {
                                                        if (num == 0 && table[k, t] == "br" && Rook(k, t, row, col) == true && table[row, col] == "." && !notation.Contains('x'))
                                                        {
                                                            start_x = k;
                                                            start_y = t;
                                                            num++;
